...
typedef struct PARAM {
	...
	int NCP; /**< Number of populated cells   -----------------------------------------------------------------Omg dont do that PLEASE lol no multi-line single line comment this makes it harder for me to comment and decomment incrementally
